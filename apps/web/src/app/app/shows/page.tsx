    ...
    return (
      <Container size="4" px="4">
        <Flex direction="column" gap="4">
          <Heading size="6">Shows</Heading>
          <Card>
            <Flex direction="column" align="start" gap="3" p="2">
              <Text color="gray">
                You are not following any shows yet. Find one and hit Follow to
      ...
      <Flex direction="column" gap="4">
        ...
        <Flex direction="column" gap="3">
          {shows.map((show) => {
            ...
            // Watched can exceed aired when specials are marked, since
            // progress counts only aired, non-special episodes.
