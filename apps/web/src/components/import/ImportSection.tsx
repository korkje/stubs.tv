import { Callout, Flex, Heading, Separator, Table, Text } from "@radix-ui/themes";
...
/**
 * The import surface, rendered as the Import tab of /app/settings: drop a
 * TV Time export, preview it (parsed in the browser, ADR-0015), commit,
 * watch the job land, then read the honest accounting — imported vs
 * TV Time's own counts, films needing a manual pick, and what was skipped.
 * Re-running an import is safe by design (everything upserts), so the
 * importer stays available below a finished job's summary.
 */
